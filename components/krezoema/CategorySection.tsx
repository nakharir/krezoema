...
export default function CategorySection() {
  const [featuredCat1, featuredCat2, ...remainingCats] = craftCategories;
    ...
    <section className="py-16 sm:py-24 bg-white border-b border-border/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          {/* Card 1: Manik Kaca (7 cols) */}
          <Link
            href={`/koleksi?kategori=${featuredCat1.slug}`}
          ...
          {/* Card 2: Akrilik (5 cols) */}
          <Link
            href={`/koleksi?kategori=${featuredCat2.slug}`}
